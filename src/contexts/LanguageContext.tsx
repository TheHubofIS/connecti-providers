...
const translations: Record<Language, Record<string, string>> = {
  fr: {
    ...
    'categories.description': 'Découvrez notre large éventail de catégories de services pour trouver exactement ce dont vous avez besoin pour votre aventure internationale.',
    'categories.searchPlaceholder': 'Rechercher une catégorie...',
    'categories.filter': 'Filtrer',
    'categories.featured': 'En vedette',
    'categories.all': 'Toutes',
    'categories.providers': 'prestataires',
    'categories.noResults': 'Aucun résultat trouvé',
    'categories.tryDifferent': 'Essayez une recherche différente ou modifiez vos filtres',
    'categories.clearFilters': 'Effacer les filtres',
    ...
    'blog.articleNotFoundDesc': 'L\'article que vous recherchez n\'existe pas ou a été déplacé.',
    'blog.share': 'Partager',
    'blog.save': 'Sauvegarder',
    'blog.aboutAuthor': 'À propos de l\'auteur',
    'blog.authorBio': 'Expert dans son domaine avec plusieurs années d\'expérience internationale, partageant ses connaissances pour aider la communauté des expatriés.',
    'blog.loginRequired': 'Connexion requise',
    'blog.loginToSave': 'Veuillez vous connecter pour sauvegarder cet article.',
    'blog.shareCopied': 'Lien partagé',
    'blog.linkCopied': 'Le lien a été copié dans le presse-papier.',
    
    // Provider
    'provider.loginRequired': 'Connexion requise',
    'provider.loginToContact': 'Veuillez vous connecter pour contacter ce prestataire.',
    'provider.notFound': 'Prestataire non trouvé',
    'provider.notFoundDesc': 'Le prestataire que vous recherchez n\'existe pas ou a été déplacé.',
    'provider.viewAll': 'Voir tous les prestataires',
    'provider.backToList': 'Retour aux prestataires',
    'provider.about': 'À propos',
    'provider.skills': 'Compétences',
    'provider.languages': 'Langues parlées',
    'provider.expertise': 'Expertise & Expérience',
    'provider.experience': 'Expérience',
    'provider.approach': 'Approche professionnelle',
    'provider.specialties': 'Spécialités',
    'provider.clientTypes': 'Types de clients',
    'provider.premiumContent': 'Contenu Premium',
    'provider.loginToView': 'Connectez-vous pour voir plus',
    'provider.education': 'Formation',
    'provider.certifications': 'Certifications',
    'provider.contactInfo': 'Coordonnées',
    'provider.practicalInfo': 'Informations pratiques',
    'provider.hourlyRate': 'Tarif horaire',
    'provider.hour': 'heure',
    'provider.responseTime': 'Temps de réponse',
    'provider.completionRate': 'Taux de complétion',
    'provider.company': 'Entreprise',
    'provider.contact': 'Contacter',
    'provider.schedule': 'Prendre rendez-vous',
    'provider.availability': 'Disponibilité',
    'provider.availabilityNote': 'Disponible du lundi au vendredi. Les rendez-vous peuvent être planifiés en ligne.',
    'provider.verifiedInfo': 'Informations vérifiées',
    'provider.identityVerified': 'Identité vérifiée',
    'provider.qualificationsVerified': 'Qualifications vérifiées',
    'provider.insuranceVerified': 'Assurance professionnelle vérifiée',
    'provider.verified': 'Prestataire vérifié',
  ...
  en: {
    ...
    'categories.description': 'Discover our wide range of service categories to find exactly what you need for your international adventure.',
    'categories.searchPlaceholder': 'Search for a category...',
    'categories.filter': 'Filter',
    'categories.featured': 'Featured',
    'categories.all': 'All',
    'categories.providers': 'providers',
    'categories.noResults': 'No results found',
    'categories.tryDifferent': 'Try a different search or modify your filters',
    ...
    'blog.articleNotFoundDesc': 'The article you are looking for doesn\'t exist or has been moved.',
    'blog.share': 'Share',
    'blog.save': 'Save',
    'blog.aboutAuthor': 'About the author',
    'blog.authorBio': 'An expert in their field with several years of international experience, sharing knowledge to help the expat community.',
    'blog.loginRequired': 'Login required',
    'blog.loginToSave': 'Please log in to save this article.',
    'blog.shareCopied': 'Link shared',
    'blog.linkCopied': 'Link copied to clipboard.',
    
    // Provider
    'provider.loginRequired': 'Login required',
    'provider.loginToContact': 'Please log in to contact this provider.',
    'provider.notFound': 'Provider not found',
    'provider.notFoundDesc': 'The provider you are looking for doesn\'t exist or has been moved.',
    'provider.viewAll': 'View all providers',
    'provider.backToList': 'Back to providers',
    'provider.about': 'About',
    'provider.skills': 'Skills',
    'provider.languages': 'Languages spoken',
    'provider.expertise': 'Expertise & Experience',
    'provider.experience': 'Experience',
    'provider.approach': 'Professional approach',
    'provider.specialties': 'Specialties',
    'provider.clientTypes': 'Client types',
    'provider.premiumContent': 'Premium Content',
    'provider.loginToView': 'Login to view more',
    'provider.education': 'Education',
    'provider.certifications': 'Certifications',
    'provider.contactInfo': 'Contact information',
    'provider.practicalInfo': 'Practical information',
    ...
    'provider.schedule': 'Schedule appointment',
    'provider.availability': 'Availability',
    'provider.availabilityNote': 'Available Monday through Friday. Appointments can be scheduled online.',
    'provider.verifiedInfo': 'Verified information',
    'provider.identityVerified': 'Identity verified',
    'provider.qualificationsVerified': 'Qualifications verified',
    'provider.insuranceVerified': 'Professional insurance verified',
  ...
  es: {
    ...
    'categories.description': 'Descubre nuestra amplia gama de categorías de servicios para encontrar exactamente lo que necesitas para tu aventura internacional.',
    'categories.searchPlaceholder': 'Buscar una categoría...',
    'categories.filter': 'Filtrar',
    'categories.featured': 'Destacados',
    'categories.all': 'Todos',
    'categories.providers': 'proveedores',
    'categories.noResults': 'No se encontraron resultados',
    'categories.tryDifferent': 'Intenta una búsqueda diferente o modifica tus filtros',
    ...
    'blog.articleNotFoundDesc': 'El artículo que buscas no existe o ha sido movido.',
    'blog.share': 'Compartir',
    'blog.save': 'Guardar',
    'blog.aboutAuthor': 'Sobre el autor',
    'blog.authorBio': 'Un experto en su campo con varios años de experiencia internacional, compartiendo conocimientos para ayudar a la comunidad expatriada.',
    'blog.loginRequired': 'Inicio de sesión requerido',
    'blog.loginToSave': 'Inicia sesión para guardar este artículo.',
    'blog.shareCopied': 'Enlace compartido',
    'blog.linkCopied': 'Enlace copiado al portapapeles.',
    
    // Provider
    'provider.loginRequired': 'Inicio de sesión requerido',
    'provider.loginToContact': 'Por favor, inicia sesión para contactar con este proveedor.',
    'provider.notFound': 'Proveedor no encontrado',
    'provider.notFoundDesc': 'El proveedor que buscas no existe o ha sido movido.',
    'provider.viewAll': 'Ver todos los proveedores',
    'provider.backToList': 'Volver a proveedores',
    'provider.about': 'Acerca de',
    'provider.skills': 'Habilidades',
    'provider.languages': 'Idiomas hablados',
    'provider.expertise': 'Experiencia y especialización',
    'provider.experience': 'Experiencia',
    'provider.approach': 'Enfoque profesional',
    'provider.specialties': 'Especialidades',
    'provider.clientTypes': 'Tipos de clientes',
    'provider.premiumContent': 'Contenido Premium',
    'provider.loginToView': 'Inicia sesión para ver más',
    'provider.education': 'Formación',
    'provider.certifications': 'Certificaciones',
    'provider.contactInfo': 'Información de contacto',
    'provider.practicalInfo': 'Información práctica',
    'provider.hourlyRate': 'Tarifa por hora',
    'provider.hour': 'hora',
    'provider.responseTime': 'Tiempo de respuesta',
    'provider.completionRate': 'Tasa de finalización',
    'provider.company': 'Empresa',
    'provider.contact': 'Contactar',
    'provider.schedule': 'Programar cita',
    'provider.availability': 'Disponibilidad',
    'provider.availabilityNote': 'Disponible de lunes a viernes. Las citas pueden programarse en línea.',
    'provider.verifiedInfo': 'Información verificada',
    'provider.identityVerified': 'Identidad verificada',
    'provider.qualificationsVerified': 'Calificaciones verificadas',
    'provider.insuranceVerified': 'Seguro profesional verificado',
    'provider.verified': 'Proveedor verificado',
    'provider.available': 'Disponible',

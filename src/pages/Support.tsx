              ...
              <Card className="border border-border hover:shadow-md transition-all duration-300">
                <CardContent className="pt-6">
                  <div className="text-center">
                    ...
                    <Link to="/faq">
                      <Button variant="outline">{translate('support.viewFAQ')}</Button>
                    </Link>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="border border-border hover:shadow-md transition-all duration-300">
                <CardContent className="pt-6">
                  <div className="text-center">
                    ...
                    <Button variant="outline">{translate('support.startChat')}</Button>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="border border-border hover:shadow-md transition-all duration-300">
                <CardContent className="pt-6">
                  <div className="text-center">
                    ...
                    <Button variant="outline">{translate('support.contactUs')}</Button>
                  </div>
                </CardContent>
              </Card>
            </div>
                  ...
                  <form className="space-y-4">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="space-y-2">
                        ...
                        <Input placeholder={translate('support.namePlaceholder')} />
                      </div>
                      <div className="space-y-2">
                        <label className="text-sm font-medium">{translate('support.emailLabel')}</label>
                        <Input placeholder={translate('support.emailPlaceholder')} />
                      </div>
                    </div>
                    <div className="space-y-2">
                      <label className="text-sm font-medium">{translate('support.subjectLabel')}</label>
                      <Input placeholder={translate('support.subjectPlaceholder')} />
                    </div>
                    <div className="space-y-2">
                      <label className="text-sm font-medium">{translate('support.messageLabel')}</label>
                      <Textarea placeholder={translate('support.messagePlaceholder')} rows={5} />
                    </div>
                    <Button type="submit" className="w-full">{translate('support.sendMessage')}</Button>
                  </form>
                </CardContent>
              </Card>
            </div>
